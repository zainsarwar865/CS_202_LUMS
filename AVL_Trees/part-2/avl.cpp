...
BST<string> one;
one.insert("zain","zain");
one.insert("aa","zasain");
one.insert("Sssd","zaina");
one.insert("sss","zainasas");
one.insert("s","zaisnsa");
one.insert("sdsd","zaisssssn");
/*one.insert("asas",2);
one.insert("asas",0);
